<template>
    <div class="main">
        ...
        <!-- 充值弹框 -->
        <el-dialog title="充值书币" :visible.sync="dialogFormVisible1">
            <el-form :model="topUpForm" ref="topUpForm">
                <el-form-item label="当前书币" 
                prop="a"
                :label-width="formLabelWidth">
                    <el-input v-model="topUpForm.a" autocomplete="off" :disabled="true"></el-input>
                </el-form-item>
                <el-form-item label="充值书币" 
                prop="a"
                :label-width="formLabelWidth">
                    <el-input v-model="topUpForm.a" autocomplete="off" clearable></el-input>
                </el-form-item>
            </el-form>
        ...
        <!-- 设置会员弹框 -->
        <el-dialog title="设置会员" :visible.sync="dialogFormVisible2">
           <div>efee</div>
            <div slot="footer" class="dialog-footer">
